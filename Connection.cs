...
namespace FOK_GYEM.Serial
{
    public class Connection
    {
        ...
        public Connection(int id, string portName = "COM1", 
            int baudRate = 9600,
            int timeout = 1000,
        ...
        public bool Init(int count, int width, int height)
        {
            ...
            {
                Console.WriteLine("Serial COM Exception :: " + ex.Message);
                Port.Close();
                IsConnected = false;
                return false;
            }
        ...
        public void Error(byte errNumber)
        {
            ...
            Console.WriteLine("Serial Communication error :: " + message);
        ...
        public void HandleException(Exception ex)
        {
            ...
            {
                Console.WriteLine("Serial COM Exception :: The serial connected controller appears to have been disconnected.");
                IsConnected = false;
            } else Console.WriteLine("Serial COM Exception :: " + ex.Message);
        }
    }
}